...
const Contact = ({id, makeFavorite, removeFavorite, removeContact, deleteContact, updateContact, enableUpdate, showInfoPage, img=userImg, name="Hina R", tag="Family", type="Mobile", favorite=false}) => {
  return (
